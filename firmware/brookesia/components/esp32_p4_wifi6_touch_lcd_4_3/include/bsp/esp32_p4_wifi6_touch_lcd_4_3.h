 ...
 * LCD interface
 *
 * The board uses a 4.3-inch ST7701 MIPI-DSI display controller.
 * It features 16-bit colors, 480x800 resolution and a capacitive touch controller.
 *
 ...
 **************************************************************************************************/
#define BSP_LCD_PIXEL_CLOCK_MHZ     (30)
