...
| 示例 07–12 中的基础 `esp32_p4_wifi6_touch_lcd_4_3` 依赖 | 固定的上游源码 | 每个基础 BSP manifest 都从[上游 PR #191](https://github.com/waveshareteam/Waveshare-ESP32-components/pull/191)锁定的提交 `ac94f5da7c0e44963828ab970337e89d23e04330` 解析，而不是使用本地副本或注册表发布版本 |
...
两个 `bsp_extra` 树仍是本地产品应用扩展。它们不是基础 BSP 的替代品；在基础 BSP 从
锁定的上游源码解析时，应有意保留。这一锁定是上游评审提交，不是 ESP Component
